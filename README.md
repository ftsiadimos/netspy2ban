...
<a href="https://github.com/ftsiadimos/netspy2ban/blob/master/rpms/netspy2ban-1.0-1.fc22.noarch.rpm?raw=true" target="_blank">Download</a> the rpm file for easy installation. It is tested for Fedora 22 version. Install the package through the software manage or with the following command "sudo dnf install netspy2ban-1.0-1.fc22.noarch.rpm"
